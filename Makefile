...
ORIG_SRCS = gtk_notebook_methods.c window.c events.c tabs.c fonts.c gtk_window_methods.c gtk_vte_methods.c gears.c gtk_widget_methods.c rtortosa.c colors.c
SRCS = $(ORIG_SRCS) 
OBJS = gtk_notebook_methods.o window.o events.o tabs.o fonts.o gtk_window_methods.o gtk_vte_methods.o gears.o gtk_widget_methods.o rtortosa.o colors.o
HDRS = $(srcdir)/tabs.h $(srcdir)/window.h $(srcdir)/fonts.h $(srcdir)/gtk_notebook_methods.h $(srcdir)/pango-color-table.h $(srcdir)/gtk_window_methods.h $(srcdir)/events.h $(srcdir)/backbone.h $(srcdir)/colors.h $(srcdir)/gtk_widget_methods.h $(srcdir)/dbg.h $(srcdir)/gears.h $(srcdir)/gtk_vte_methods.h
TARGET = rtortosa
